...
<div class="offset-3 col-6 pt-5">
	<form action="EditProfile" method="POST">
		<h2 class="text-center text-primary">Sửa thông tin</h2>
		<jsp:include page="/common/inform.jsp"></jsp:include>
		<div class="row">
			<div class="col-md-6">
				<div class="mb-3">
					<label for="" class="form-label">Username</label> <input
						type="text" class="form-control" name="username" id="" value="${user.username }"/>
				</div>
				<div class="mb-3">
			...
			<div class="col-md-6">
				<div class="mb-3">
					<label for="" class="form-label">Full name</label> <input
						type="text" class="form-control" name="fullname" id="" value="${user.fullname }"/>
				</div>
				<div class="mb-3">
